    ...
    public function prepare_items() {
	    ...
	    foreach ( $orders as $order ) {
		    if (
                ...
                $row['remove-submitted-order'] = '<input type="button" class="libanpost-remove-btn" id="libanpost-remove-btn" onclick="removeOrder(' . $order->get_id() . ')" value="Remove"><span class="libanpost-loader-remove-btn libanpost-loader-remove-btn-additional-property" id="libanpost_loader_remove_btn"></span>';
